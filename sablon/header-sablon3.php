...
<header class="header3">
    ...
    <nav id="navbar_main" class="d-none d-lg-block navbar navbar-expand-lg navbar-light p-0 shadow-sm mb-3 border-0">
        <?php if (get_post_type() != 'resmi-ilanlar'): ?>
            <div class="header-ust header-bg bg-dark">
                <div class="container">
                    <div class="row justify-content-between text-muted align-items-center fz-13">
                        <div class="col">
                            ...
                            <div class="row align-items-center mb-0 g-2">
                                <div class="col-auto">
                                    <div class="dugme rounded-2 d-flex align-items-center justify-content-center" style="width: 41.59px;height: 41.59px;">
                                        <label for="darkModeToggleInput1" class="nav-link p-2 h-100 form-check-input-darkmode-label text-center position-relative d-block w-100">
                                ...
                                <div class="col-auto">
                                    <div class="dugme rounded-2 d-flex align-items-center justify-content-center" style="width: 41.59px;">
                                        <a href="#ara" type="button" class="nav-link p-2 h-100 nav-arama text-center" aria-label="Arama modalını aç"
                                ...
                                <div class="col-auto dropdown">
                                    <div class="dugme rounded-2 d-flex align-items-center justify-content-center" style="width: 41.59px; height: 41.59px;" data-bs-toggle="dropdown" aria-expanded="false" role="button" aria-label="Kullanıcı menüsünü aç">
                                        <a class="nav-link p-0 h-100 text-center d-flex align-items-center justify-content-center w-100" aria-label="Kullanıcı menüsü">
                                ...
                                <div class="col-auto dropdown">
                                    ...
                                    <div class="dugme rounded-2 d-flex align-items-center justify-content-center" style="width: 41.59px;" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" role="button" aria-label="Bildirim menüsünü aç">
                                        <a class="nav-link p-2 h-100 text-center position-relative" aria-label="Bildirimler">
        ...
        <?php endif; ?>
        <div class="header-bg bg-dark pt-2 pb-4">
            <div class="container">
        ...
        <?php if (get_post_type() != 'resmi-ilanlar'): ?>
            <div class="header-alt header bg-white bg-opacity-90">
                <div class="container">
                        ...
                        <div class="col-auto px-0">
                            <ul id="menu-ana-menu-1" class="navbar-nav d-flex justify-content-between align-items-center ">
                                <li
                                    ...
                                    <a href="#" class="nav-link dropdown-toggle me-0 sagMenu" data-bs-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false" aria-label="Diğer sayfalar menüsünü aç">
                                        <i class="ri-apps-fill fz-18"></i>
                                        Diğer Sayfalar
                                    </a>
