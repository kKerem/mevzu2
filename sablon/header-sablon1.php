...
<header class="header1">
    ...
    <nav id="navbar_main" class="d-none d-lg-block navbar navbar-expand-lg navbar-light p-0 shadow-sm mb-3">
        <?php if (get_post_type() != 'resmi-ilanlar'): ?>
            <div class="header-ust header-bg">
                <div class="container">
                    <div class="row justify-content-between text-muted align-items-center mt-2 fz-13">
                        <div class="col-auto">
                                                ...
                                                <div class="row align-items-center justify-content-end gx-2">
                                                    <?php foreach ($group as $kur => $bilgi) { ?>
                                                        <div class="col-auto borsa-text">
                                                            <a href="<?= bloginfo('url') ?>/finans/<?php echo mb_strtoupper($kur); ?>" class="nav-link py-2">
        ...
        <div class="header-bg py-2">
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto justify-self-end ms-auto">
                        <div class="row align-items-center mb-0 g-2">
                            <div class="col-auto">
                                <?php display_havadurumu_temperature($sablon = 'sablon-3'); ?>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="col-auto">
                                <div class="dugme rounded-2 d-flex align-items-center justify-content-center" style="width: 41.59px;">
                                    <a href="#ara" type="button" class="nav-link p-2 h-100 nav-arama text-dark text-hover text-center" aria-label="Arama modalını aç"
                                    data-bs-toggle="modal" data-bs-target="#aramaYap">
                                    <i class="ri-search-2-line fz-16"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-auto dropdown">
                                ...
                                ?>
                                <div class="dugme rounded-2 d-flex align-items-center justify-content-center" style="width: 41.59px;" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" role="button" aria-label="Bildirim menüsünü aç">
                                    <a class="nav-link p-2 h-100 text-dark text-hover text-center position-relative" aria-label="Bildirimler">
                                        ...
                                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger mevzu-notif-badge fz-10<?php echo $unread_count === 0 ? ' d-none' : ''; ?>">
                                        ...
                                        <div class="row header-section1 small">
                                            ...
                                            if (!empty($bulunan_sayfalar)) {
                                                echo '<div class="col-12 col-md-auto">
                                                    ...
                                                    <div class="d-flex align-items-strech flex-wrap flex-column">';
                                                        foreach ($bulunan_sayfalar as $item) {
                                                            echo '<a href="' . get_permalink($item['sayfa']->ID) . '" class="text-link fw-normal d-block"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M17.92 11.62a1 1 0 0 0-.21-.33l-5-5a1 1 0 0 0-1.42 1.42l3.3 3.29H7a1 1 0 0 0 0 2h7.59l-3.3 3.29a1 1 0 0 0 0 1.42a1 1 0 0 0 1.42 0l5-5a1 1 0 0 0 .21-.33a1 1 0 0 0 0-.76"/></svg>';
    ...
    <div id="stickyNavbar" class="bg-white header-alt header shadow-sm"<?php if (is_user_logged_in()) echo ' style="margin-top: var(--mevzu-offcanvas-sticky);"'; ?>>
            <div class="container">
            <?php if (!is_single()): ?>
                <nav class="navbar navbar-expand-lg navbar-light py-0 shadow-none d-none d-md-block">
                    ...
                    <div class="row align-items-center mx-0">
                        <div class="col-auto position-relative">
                            <a href="<?php bloginfo('url'); ?>" class="nav-link d-flex align-items-center link-home py-1" aria-label="Ana sayfaya git">
                                <i class="ri-home-3-line fz-20"></i>
                            </a>
                        </div>
                        ...
                        <div class="col-auto px-0">
                            <ul id="menu-ana-menu-1" class="navbar-nav d-flex justify-content-between align-items-center ">
                                <li
                                    ...
                                    <a href="#" class="nav-link d-flex align-items-center dropdown-toggle ps-1 pe-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Diğer sayfalar menüsünü aç">
                                        <i class="ri-menu-3-fill fz-18"></i>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" data-popper-placement="null" data-bs-popper="static">
                                        <?php wp_nav_menu(array(
                                            'theme_location' => 'ust-menu',
                                            'container' => false,
                                            'menu_class' => '',
                ...
                <div class="row align-items-center py-2">
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col-auto pe-1">
                                <div class="text-danger d-none d-md-inline-flex">
                                    <i class="ri-article-line fs-4"></i>
                                </div>
                            </div>
                            <div class="col">
                                <h1 id="fixed-post-title" class="single-title m-0 fz-18 satir-1 border-start ps-3"><?php the_title() ?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-auto ms-auto">
                        <div class="row align-items-center gx-3">
                            <div class="col-auto">
                                <div class="input-group sizing-buttons">
                                    <button class="btn btn-secondary sizing fontminus p-0" type="button" data-bs-placement="bottom" data-bs-toggle="tooltip" data-bs-title="<small>Yazıyı Küçült</small>" data-bs-custom-class="p-0" data-bs-custom-class="bg-opacity-50" data-bs-html="true">A-</button>
                                    <button class="btn btn-secondary sizing fontplus p-0" type="button" data-bs-placement="bottom" data-bs-toggle="tooltip" data-bs-title="<small>Yazıyı Büyült</small>" data-bs-custom-class="p-0" data-bs-custom-class="bg-opacity-50" data-bs-html="true">A+</button>
                                </div>
                            </div>
                            ...
                            <?php } ?>
                            <div class="col-auto">
                                <button type="button" class="btn btn-secondary rounded-pill py-1 px-3 border-0 text-capitalize btn-paylas d-inline-flex align-items-center gap-1 fw-semibold" data-bs-toggle="modal" data-bs-target="#paylas">
