...
define('BULK_IMAGE_RESIZER_DIR', __DIR__ . '/');
define('BULK_IMAGE_RESIZER_URL', get_template_directory_uri() . '/inc/bulk-image-resizer/');

require __DIR__ . '/includes/class-hiz-guvenlik-init.php';
...
// Tema içinden yüklendiğinde plugin activation/uninstall hook'ları kullanılmaz.
